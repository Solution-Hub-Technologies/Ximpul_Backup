...
// Handle file upload or base64 PDF - support multiple parameter names
$attachment = '';
$attachment_name = 'attachment.pdf';

// Check for 'attachment' parameter (used by BulkOrder)
if (isset($_POST['attachment']) && !empty($_POST['attachment'])) {
    $attachment = $_POST['attachment'];
    $attachment_name = $_POST['attachment_name'] ?? 'attachment.pdf';
    error_log('Attachment received (attachment param): ' . $attachment_name . ', size: ' . strlen($attachment));
}
// Check for 'pdf_base64' parameter (legacy support)
elseif (isset($_POST['pdf_base64']) && !empty($_POST['pdf_base64'])) {
